...
function colision(){
  ...
  var pelota2 = THREE.ImageUtils.loadTexture('https://karenkwz.github.io/ProyectoFinal/colores.gif');
...
function setup(){
  ...
  cubo1 = new THREE.Mesh( new CubeGeometry(50,200,700),
                          new THREE.MeshNormalMaterial());
  cubo2 = new THREE.Mesh( new CubeGeometry(50,200,700),
                          new THREE.MeshNormalMaterial());
  cubo3 = new THREE.Mesh( new CubeGeometry(50,200,700),
                          new THREE.MeshNormalMaterial());
  cubo4 = new THREE.Mesh( CubeGeometry(50,200,700),
                          new THREE.MeshNormalMaterial());
 cubo5 = new THREE.Mesh( CubeGeometry(5600,200,50),
                          new THREE.MeshNormalMaterial());
 cubo6 = new THREE.Mesh( CubeGeometry(5600,200,50),
                          new THREE.MeshNormalMaterial());
...
var raycaster1, raycaster2, reycaster3, reycaster4, reycaster5, reycaster6, step;
