...
this.cuerpo = new THREE.Mesh(new THREE.SphereGeometry(3,100,100),new THREE.MeshLambertMaterial({map:cara}));
  this.brazoI = new THREE.Mesh(new THREE.BoxGeometry(1,1,3),new THREE.MeshLambertMaterial({map:brazos}));
  this.brazoD = new THREE.Mesh(new THREE.BoxGeometry(1,1,3),new THREE.MeshLambertMaterial({map:brazos}));
