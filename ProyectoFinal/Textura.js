...
this.cuerpo = new THREE.Mesh(new THREE.SphereGeometry(3,100,100),new THREE.MeshLambertMaterial({map:cara}));
  ...
  this.pieI = new THREE.Mesh(new THREE.SphereGeometry(1,1,1),new THREE.MeshLambertMaterial({map:pies}));
  this.pieD = new THREE.Mesh(new THREE.SphereGeometry(1,1,1),new THREE.MeshLambertMaterial({map:pies}));
