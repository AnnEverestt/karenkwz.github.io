function Completo(){
  ...
  var cara = THREE.ImageUtils.loadTexture('https://karenkwz.github.io/ProyectoFinal/hipnotizar.gif');
  ...
  this.cuerpo = new THREE.Mesh(new THREE.SphereGeometry(1,100,100),new THREE.MeshLambertMaterial({map:cara}));
